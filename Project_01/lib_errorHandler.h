...
#define ERR_3_ACTION_NOT_DEFINED "Not a valid action input.\n"
#define ERR_4_NUMBER_NOT_DEFINED "Not a valid number input.\n"
#define ERR_5_NOT_ENOUGH_VALUES "Not enough values were input.\n"
// Declerations -------------------------------------------------------------------------------------------------------
